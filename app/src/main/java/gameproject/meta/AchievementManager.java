...
public class AchievementManager {
    ...
    private void initAchievements() {
        ...
        // BOSS
        addAchievement(new Achievement("boss_soul_reaper", "Death Defier", "Defeat Soul Reaper", "boss", 1, 500, 2));
        addAchievement(new Achievement("boss_the_shadow", "Shadow Slayer", "Defeat Shadow Boss", "boss", 1, 800, 4));
        addAchievement(new Achievement("boss_the_dark_fairy", "Dark Wings", "Defeat Dark Fairy", "boss", 1, 1200, 8));
        addAchievement(new Achievement("boss_the_king", "Regicide", "Defeat King Boss", "boss", 1, 1600, 12));
        addAchievement(new Achievement("boss_phantom_warlock", "Soul Manipulator", "Defeat Phantom Warlock", "boss", 1, 2000, 20));
        addAchievement(new Achievement("boss_cannon_turtle", "Heavy Artillery", "Defeat the Swamp Cannon Boss", "boss", 1, 1000, 5));
        addAchievement(new Achievement("boss_swamp_priest", "Holier Than Thou", "Defeat the Swamp Priest", "boss", 1, 2500, 25));
        ...
        addAchievement(
                new Achievement("event_darkness", "Night Owl", "Encounter the Darkness event", "event", 1, 500, 2));
        addAchievement(new Achievement("event_acid_rain", "Under the Shelter", "Encounter the Acid Rain event", "event",
                1, 500, 2));
        addAchievement(new Achievement("event_mimic_mania", "Trust Issues", "Encounter the Mimic Mania event", "event",
                1, 500, 2));
        addAchievement(new Achievement("event_blood_moon", "Bloodthirst", "Encounter the Blood Moon event", "event", 1,
                1000, 5));
        addAchievement(
                new Achievement("event_toxic_waters", "Toxic Dip", "Encounter the Toxic Waters event", "event", 1,
                        500, 2));
        addAchievement(new Achievement("death_toxic_waters", "Melted", "Die in toxic water during the event", "fail", 1,
                500, 5));
        addAchievement(
                new Achievement("altar_success", "Ascended", "Successfully complete the Altar Ascension", "event", 1,
                        2000, 10));
        addAchievement(new Achievement("altar_fail", "Unworthy", "Fail the Altar Ascension", "event", 1,
                500, 1));
        ...
        addAchievement(
                new Achievement("kill_10000", "Natural Disaster", "Kill 10000 enemies", "kills", 10000, 2000, 20));
        ...
        addAchievement(
                new Achievement("combat_combo_3", "Untouchable God", "Reach 200 Combo", "combat", 200, 1500, 15));

        addAchievement(new Achievement("combat_flawless_1", "Untouchable", "Complete 1 wave without taking damage",
                "combat", 1, 300, 3));
        addAchievement(new Achievement("combat_flawless_2", "Matrix Style", "Complete 5 waves without taking damage",
                "combat", 5, 800, 8));
        addAchievement(new Achievement("combat_flawless_3", "Can't Touch This",
                "Complete 10 waves without taking damage", "combat", 10, 2000, 20));

        addAchievement(new Achievement("combat_pacifist_1", "Non-Violent Resistance", "Survive 1 wave without shooting",
                "combat", 1, 500, 5));
        addAchievement(new Achievement("combat_pacifist_2", "Gandhi Mode", "Survive 3 waves without shooting", "combat",
                3, 1200, 12));
        addAchievement(new Achievement("combat_pacifist_3", "Pure Zen", "Survive 5 waves without shooting", "combat", 5,
                3000, 30));

        // CATEGORY 2: WEALTH & PROGRESS
        addAchievement(
                new Achievement("wealth_gold_1", "Spare Change", "Collect 500 gold in one run", "wealth", 500, 100, 1));
        addAchievement(new Achievement("wealth_gold_2", "Gold Digger", "Collect 2000 gold in one run", "wealth", 2000,
                500, 5));
        addAchievement(new Achievement("wealth_gold_3", "Scrooge McDuck", "Collect 5000 gold in one run", "wealth",
                5000, 2000, 20));

        addAchievement(
                new Achievement("wealth_soul_1", "Soul Collector", "Collect 100 total souls", "souls", 100, 500, 5));
        addAchievement(new Achievement("wealth_soul_2", "Reaper", "Collect 500 total souls", "souls", 500, 1500, 15));
        addAchievement(new Achievement("wealth_soul_3", "Death's Best Friend", "Collect 2000 total souls", "souls",
                2000, 5000, 50));

        addAchievement(new Achievement("wealth_peak", "Over 9000!", "Max out any stat", "wealth", 1, 1000, 10));

        // CATEGORY 3: EXPLORATION
        addAchievement(new Achievement("explorer_marathon_1", "Steady Strides", "Travel 100k pixels", "explorer",
                100000, 200, 2));
        addAchievement(
                new Achievement("explorer_marathon_2", "Leg Day", "Travel 300k pixels", "explorer", 300000, 600, 6));
        addAchievement(new Achievement("explorer_marathon_3", "Forrest Gump", "Travel 1M pixels", "explorer", 1000000,
                2000, 20));

        addAchievement(new Achievement("explorer_homebody_1", "Rent Free", "Stay in buildings for 2 mins", "explorer",
                2, 200, 2));
        addAchievement(new Achievement("explorer_homebody_2", "Squatter", "Stay in buildings for 5 mins", "explorer", 5,
                500, 5));
        addAchievement(new Achievement("explorer_homebody_3", "Real Estate Mogul", "Stay in buildings for 10 mins",
                "explorer", 10, 1500, 15));

        addAchievement(
                new Achievement("explorer_lucky", "Jackpot!", "Find 3 items in one chest", "explorer", 1, 500, 5));
        addAchievement(new Achievement("explorer_architect", "The Grand Tour", "Visit all buildings in a run",
                "explorer", 1, 1000, 10));

        // SECRETS
        addAchievement(new Achievement("secret_3_evolutions", "Weapon Master", "Unlock 3 different evolved weapons",
                "secret", 3, 2000, 15));
        addAchievement(new Achievement("secret_mimic_trap", "Bamboozled", "Encounter a Mimic in a treasure chest",
                "secret", 1, 500, 5));
        addAchievement(new Achievement("secret_admin_access", "There is no Spoon", "Enter the correct Admin password",
                "secret", 1, 1000, 10));
        addAchievement(new Achievement("secret_untouchable", "God Mode", "Complete a run without taking damage",
                "secret", 1, 5000, 50));
        addAchievement(new Achievement("secret_speedrunner", "Sonic Speed", "Complete game in under 15 minutes",
                "secret", 1, 2000, 20));
        addAchievement(new Achievement("secret_clutch_survivor", "Living on the Edge",
                "Survive 5 mins with 1 HP remaining", "secret", 1, 3000, 30));
        addAchievement(new Achievement("secret_no_dash", "The Floor is Lava", "Complete a run without using Dash",
                "secret", 1, 3000, 30));
        addAchievement(new Achievement("secret_phantom_troll", "Stop Hitting Yourself",
                "Hit Phantom clones 10 times before killing it", "secret", 1, 2000, 20));
        addAchievement(
                new Achievement("secret_diver", "I Am Under The Water", "Stay in water continuously for 1 minute",
                        "secret", 1, 2000, 20));
        ...
        addAchievement(
                new Achievement("destroy_10", "Vandal", "Destroy 10 environment objects", "destroy", 10, 200, 1));
        addAchievement(new Achievement("destroy_100", "Demolition Man", "Destroy 100 environment objects", "destroy",
                100, 1000, 10));
    }
    ...
    public void onStatChanged(String category, int value, String specificId) {
        for (Achievement a : achievements.values()) {
            ...
            if (specificId != null && !a.id.toLowerCase().contains(specificId.toLowerCase())) {
                continue;
            }
    ...
    public void onBossKilled(String bossName) {
        ...
        String achievementId = "boss_" + bossName.toLowerCase().trim().replace(" ", "_");
        onSpecificBossKilled(achievementId);
    }

    public void onSpecificBossKilled(String achievementId) {
        Achievement a = achievements.get(achievementId);
        if (a != null && !a.isCompleted) {
            a.updateProgress(a.targetValue);
            toastQueue.add(a);
            gameproject.SoundManager.play("achievement");
            save();
        }
    ...
    public void drawToast(Graphics g, int sw, int sh) {
        ...
        if (elapsed < 500)
            ...
            alpha = Math.max(0, 1.0f - (elapsed - 3500) / 500f);
            ...
            if (loaded != null) {
                for (Map.Entry<String, Achievement> entry : loaded.entrySet()) {
                    ...
                    if (current != null) {
                        ...
                        // TỰ ĐỘNG TÍNH TOÁN LẠI TRẠNG THÁI NẾU TARGET THAY ĐỔI
                        if (current.currentValue < current.targetValue) {
                            current.isCompleted = false;
                        } else if (current.currentValue >= current.targetValue) {
